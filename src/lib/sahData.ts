...
export const FULL_CATALOGUE_PRODUCTS: SAHProduct[] = [
  ...
  // B. Locks & Latches
  { id: 'sa-11', saCode: 'SA-11', name: 'Lock – HDPVC / Metal', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', finishes: ['CP (Silver)', 'Black', 'Ivory', 'Dark Brown', 'Gold', 'White', 'Matte Black'], shortDesc: 'Versatile HDPVC & metal body lock mechanism available in 7 premium finishes.', image: '/lock-hdpvc-metal-v1.png' },
  ...
  { id: 'sa-43', saCode: 'SA-43', name: 'Pencil Door Closer', categorySlug: 'door-closers', categoryName: 'Door Closers', shortDesc: 'Slimline pencil-type pneumatic door closer for screen doors and light shutters.', image: '/pencil-door-closer-v1.png' },
  { id: 'sa-44', saCode: 'SA-44', name: 'Capsule Door Closer', categorySlug: 'door-closers', categoryName: 'Door Closers', shortDesc: 'Heavy-duty capsule body hydraulic door closer for high-traffic entryways.', image: '/capsule-closer-v1.png' },
  ...
  { id: 'sa-48', saCode: 'SA-48', name: 'VHB Tape – Grey', categorySlug: 'tapes-sealants-adhesives', categoryName: 'Tapes, Sealants & Adhesives', shortDesc: 'Heavy structural grey double-sided VHB tape for cladding & facade bonding.', image: '/vhb-tape-grey-v1.png' },
  { id: 'sa-49', saCode: 'SA-49', name: 'Rubber Weather Strip Gasket', categorySlug: 'tapes-sealants-adhesives', categoryName: 'Tapes, Sealants & Adhesives', shortDesc: 'EPDM rubber glazing gasket for waterproof window sealing.', image: '/rubber1.png' },
  { id: 'sa-55', saCode: 'SA-55', name: 'Silicone Sealant', categorySlug: 'tapes-sealants-adhesives', categoryName: 'Tapes, Sealants & Adhesives', shortDesc: 'Neutral cure weatherproofing silicone sealant cartridge for perimeter gaps.', image: '/silicon.png' },
  { id: 'sa-56', saCode: 'SA-56', name: 'PU Foam (Insulation Sealant)', categorySlug: 'tapes-sealants-adhesives', categoryName: 'Tapes, Sealants & Adhesives', shortDesc: 'Expanding Polyurethane foam for gap filling, thermal & sound insulation around door frames.', image: '/pu%20foam%201.png' },
  { id: 'sa-57', saCode: 'SA-57', name: 'Silicone Gun', categorySlug: 'tapes-sealants-adhesives', categoryName: 'Tapes, Sealants & Adhesives', shortDesc: 'Heavy-duty steel skeleton caulking gun for 300ml sealant cartridges.', image: '/silicon%20gun.png' },

  // J. Fasteners & Screws
  { id: 'sa-58', saCode: 'SA-58', name: 'SDS Self Drilling Screws', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Hardened zinc-plated self-drilling screws for aluminium & sheet metal framing.', image: '/selfdriling%20screw.png' },
  { id: 'sa-59', saCode: 'SA-59', name: 'Black Drywall Screws', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Black phosphate bugle head screws for partition & drywall fixing.', image: '/black%20drywall%20screw.png' },
  { id: 'sa-60', saCode: 'SA-60', name: 'Wood Screws', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Countersunk head wood screws for timber and frame anchor applications.', image: '/wood%20screw.png' },
  { id: 'sa-61', saCode: 'SA-61', name: 'Carriage Bolt', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Square neck carriage bolts for heavy timber & steel hardware joints.', image: '/carriage%20bolt.png' },
  { id: 'sa-62', saCode: 'SA-62', name: 'STS Self Tapping Screws', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Precision self-tapping screws for aluminium extrusions and hardware brackets.', image: '/self%20tapping%20screw.png' },
  { id: 'sa-63', saCode: 'SA-63', name: 'Friction Stay Hinges', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Heavy-duty SS friction stay arm for casement windows.', image: '/stay%20hinge.png' },
  { id: 'sa-64', saCode: 'SA-64', name: 'Arm Stay', categorySlug: 'fasteners-screws', categoryName: 'Fasteners & Screws', shortDesc: 'Window restrictor arm stay for controlled ventilation safety.', image: '/arm%20stay.png' },

  // K. Glass Hardware & Shower Fittings
  { id: 'sa-65', saCode: 'SA-65', name: 'Sliding Roller (Glass)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Frameless glass door top track hanger roller with smooth ball bearings.', image: '/sliding%20roller1.png' },
  { id: 'sa-66', saCode: 'SA-66', name: 'Glass Knob', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Back-to-back brass & SS knob for shower doors and glass cabinets.', image: '/knob.png' },
  { id: 'sa-67', saCode: 'SA-67', name: 'Round Concealed Glass Handle', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Flush recessed circular pull handle for frameless glass sliding doors.', image: '/round%20concealed%20handle.png' },
  { id: 'sa-68', saCode: 'SA-68', name: 'Glass to Glass Connector', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: '180° straight glass-to-glass structural fixing clamp.', image: '/glass%20to%20glass.png' },
  { id: 'sa-69', saCode: 'SA-69', name: 'Wall to Glass Connector', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: '90° wall mounting bracket clamp for fixed glass partition panels.', image: '/wall%20to%20glass.png' },
  { id: 'sa-70', saCode: 'SA-70', name: 'Center Lock', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Mid-height patch lock for glass doors with key & thumbturn.', image: '/center lock.png' },
  { id: 'sa-71', saCode: 'SA-71', name: 'Patch Lock', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Bottom corner glass patch fitting lock for tempered glass entry doors.', image: '/patch lock.png' },
  { id: 'sa-72', saCode: 'SA-72', name: 'Big-L Connector', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Large L-bracket connector clamp for structural glass corner joints.', image: '/big l.png' },
  { id: 'sa-73', saCode: 'SA-73', name: 'Small-L Connector', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Compact L-connector clamp for shower cubicle glass joints.', image: '/small l.png' },
  { id: 'sa-74', saCode: 'SA-74', name: 'Wall to Glass Connector (CPY)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', shortDesc: 'Polished Chrome (CPY) heavy wall-to-glass clamp bracket.', image: '/wall to glass connector.png' },
  { id: 'sa-75', saCode: 'SA-75', name: 'Shower Hinge – 0° Fix Clip (CP)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', finishes: ['Chrome Plated (CP)'], shortDesc: 'Fixed wall clip hinge for stationary shower enclosure glass panels.', image: '/shower hinge 0.png' },
  { id: 'sa-76', saCode: 'SA-76', name: 'Shower Hinge – 90° Wall to Glass (CP)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', finishes: ['Chrome Plated (CP)'], shortDesc: 'Spring-loaded self-closing 90° wall-to-glass shower door hinge.', image: '/shower hinge 90.png' },
  { id: 'sa-77', saCode: 'SA-77', name: 'Shower Hinge – 180° Glass to Glass (CP)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', finishes: ['Chrome Plated (CP)'], shortDesc: '180° straight inline glass-to-glass swing hinge for frameless shower doors.', image: '/shower hinge 180.png' },
  { id: 'sa-78', saCode: 'SA-78', name: 'Shower Hinge – 90° Double Glass to Glass (CP)', categorySlug: 'glass-hardware-shower-fittings', categoryName: 'Glass Hardware & Shower Fittings', finishes: ['Chrome Plated (CP)'], shortDesc: 'Corner 90° double glass-to-glass shower door hinge in high CP mirror polish.', image: '/shower hinge 90 double.png' },

  // L. Abrasives, Mesh & Misc.
  { id: 'sa-79', saCode: 'SA-79', name: 'Flap Disk', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Zirconia abrasive flap grinding disk for aluminium weld & edge smoothing.', image: '/flap disk.png' },
  { id: 'sa-80', saCode: 'SA-80', name: 'Cutting Wheel', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Ultra-thin reinforced metal & aluminium profile cutting wheel disk.', image: '/cutting wheel.png' },
  { id: 'sa-81', saCode: 'SA-81', name: 'Machar Jaali (Mosquito Mesh)', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', sizes: ['2ft', '2.5ft', '3.5ft', '3.75ft', '5ft'], variants: ['Full Roll', 'Short Cut'], shortDesc: 'SS / Aluminium insect screen mesh available in 5 standard width rolls.', image: '/macchar jali.png' },
  { id: 'sa-82', saCode: 'SA-82', name: 'Aluminium Louvers', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Ventilation louver blades for bathroom & kitchen window shutters.', image: '/louvers.png' },
  { id: 'sa-83', saCode: 'SA-83', name: 'Black Jaali (Powder Coated)', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Matte black anti-corrosion mesh for modern window security screens.', image: '/black jali.png' },
  { id: 'sa-84', saCode: 'SA-84', name: 'Plastic Jaali', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'High-density HDPE plastic mesh for economical window insect screening.', image: '/plastic jali.png' },
  { id: 'sa-85', saCode: 'SA-85', name: 'Corner Cleat (Joint Key)', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Internal aluminium corner cleat joint for 90° window frame crimping.', image: '/corner cleat.png' },
  { id: 'sa-86', saCode: 'SA-86', name: 'Espag (Espagnolette Lock)', categorySlug: 'abrasives-mesh-misc', categoryName: 'Abrasives, Mesh & Misc.', shortDesc: 'Multi-point espagnolette locking gear rod for casement window sashes.', image: '/espag.png' }
];
...
export const SAH_FAQS: SAHFAQ[] = [
  ...
  },
  {
    ...
    answer: 'Our main showroom and wholesale distribution hub is located at Shop No. 3, Near Mahavir Traders, Punjab Oil Mill Road, Bhaisthan, Raipur, Chhattisgarh (492001). We supply across Chhattisgarh and surrounding states with rapid dispatch.',
