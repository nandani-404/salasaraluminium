...
export const FULL_CATALOGUE_PRODUCTS: SAHProduct[] = [
  // A. Rollers, Bearings & Channels
  { id: 'sa-1-2', saCode: 'SA-1 / SA-2', name: 'Track Brush (Weatherstrip)', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', finishes: ['Black (SA-1)', 'Grey (SA-2)'], shortDesc: 'Dense nylon dust & weather draft sealing brush for sliding aluminium tracks.', image: '/track-brush-v2.png' },
  { id: 'sa-3', saCode: 'SA-3', name: 'Bearing 625-626', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'High-precision 625/626 miniature ball bearing for smooth silent sliding mechanisms.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-4', saCode: 'SA-4', name: 'Bearing 22', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'Heavy-duty size 22 steel bearing for architectural sliding doors.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-5', saCode: 'SA-5', name: '16mm Needle Bearing', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: '16mm high radial load needle bearing for compact hardware assemblies.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-6', saCode: 'SA-6', name: 'Metal Bearing Roller', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'Zinc-plated metal bearing housing built for commercial heavy load tracks.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-7', saCode: 'SA-7', name: 'Sliding Roller', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'Standard single wheel nylon sliding roller for aluminium window shutters.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-8', saCode: 'SA-8', name: 'Double Swing Roller', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'Self-aligning double swing roller assembly for heavy sliding patio doors.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-9', saCode: 'SA-9', name: 'C-Roller', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'C-section track roller wheel designed for smooth low-friction gliding.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  { id: 'sa-10', saCode: 'SA-10', name: 'G-Roller', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'G-profile guiding roller wheel assembly for specialized architectural sections.', image: 'https://images.unsplash.com/photo-1581092335397-9583fe92d232?w=600&q=80' },
  ...
  { id: 'sa-17', saCode: 'SA-17', name: 'Domal Lock', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Heavy-duty mortise lock system designed specifically for Domal sliding window sections.', image: '/cat-locks.png' },
  { id: 'sa-18', saCode: 'SA-18', name: 'S.S Lock – State', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Corrosion-resistant Stainless Steel straight latch lock for harsh environments.', image: '/cat-locks.png' },
  { id: 'sa-19', saCode: 'SA-19', name: 'S.S Lock – L', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Premium Grade 304 Stainless Steel L-type window lock assembly.', image: '/cat-locks.png' },
  { id: 'sa-20', saCode: 'SA-20', name: 'T-Lock', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'T-handle security latch lock for commercial window sashes.', image: '/cat-locks.png' },
  { id: 'sa-21', saCode: 'SA-21', name: 'Crescent Lock', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Classic rotating crescent sash lock for aluminium sliding window interlocks.', image: '/cat-locks.png' },
  { id: 'sa-22', saCode: 'SA-22', name: 'Maruti Lock', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Compact Maruti-type side latch lock for residential window frames.', image: '/cat-locks.png' },
  { id: 'sa-23', saCode: 'SA-23', name: 'Air Lift Lock', categorySlug: 'locks-latches', categoryName: 'Locks & Latches', shortDesc: 'Air Lift vertical sliding sash lock mechanism for heavy glazed windows.', image: '/cat-locks.png' },
  ...
  // E. Door Kits
  { id: 'sa-30-31', saCode: 'SA-30 / SA-31', name: 'SS Mini Door Kit', categorySlug: 'door-kits', categoryName: 'Door Kits', finishes: ['SS Natural (SA-30)', 'Matte Black (SA-31)'], shortDesc: 'Compact Stainless Steel door hardware kit including handle, latch, and stopper.', image: '/sku-sa33.png' },
  { id: 'sa-32', saCode: 'SA-32', name: 'Door Stopper', categorySlug: 'door-kits', categoryName: 'Door Kits', shortDesc: 'Wall and floor mounted rubber-head door stopper in solid finish.', image: '/sku-sa33.png' },
  { id: 'sa-33', saCode: 'SA-33', name: 'Aluminium Door Kit', categorySlug: 'door-kits', categoryName: 'Door Kits', finishes: ['Black', 'Brown', 'Champion', 'Matt', 'CP'], shortDesc: 'Complete architectural aluminium door fittings kit available in 5 finishes.', image: '/sku-sa33.png' },
