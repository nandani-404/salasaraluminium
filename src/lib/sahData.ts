...
export const FULL_CATALOGUE_PRODUCTS: SAHProduct[] = [
  ...
  { id: 'sa-3', saCode: 'SA-3', name: 'Bearing 625-626', categorySlug: 'rollers-bearings-channels', categoryName: 'Rollers, Bearings & Channels', shortDesc: 'High-precision 625/626 miniature ball bearing for smooth silent sliding mechanisms.', image: '/bearing 625-626.png' },
